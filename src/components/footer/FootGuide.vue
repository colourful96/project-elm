...
<template>
  <section id="foot_guide">
    ...
    <section class="guide_item" @click="gotoAddress({path:'/msite',query:{geohash:store.geohash}})">
    ...
    <section class="guide_item" @click="gotoAddress({path:`/search/${store.geohash}`})">
      <svg class="icon_style">
        <use xmlns:xlink="http://www.w3.org/1999/xlink"
    ...
    <section class="guide_item" @click="gotoAddress({path:'/profile',query:{geohash:store.geohash}})">
      <svg class="icon_style">
        <use xmlns:xlink="http://www.w3.org/1999/xlink"
